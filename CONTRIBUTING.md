...
This project adheres to the [Contributor Covenant Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior via [GitHub Issues](https://github.com/Ankitsatnami/RW_HUB_apk/issues).
...
|---|---|
| 🐛 **Bug Reports** | Found something broken? [Open a bug report](https://github.com/Ankitsatnami/RW_HUB_apk/issues/new?template=bug_report.yml) |
| 💡 **Feature Requests** | Have an idea? [Suggest a feature](https://github.com/Ankitsatnami/RW_HUB_apk/issues/new?template=feature_request.yml) |
...
git remote add upstream https://github.com/Ankitsatnami/RW_HUB_apk.git
...
5. **Open a Pull Request** against `Ankitsatnami/RW_HUB_apk:main`.
...
Use the [Bug Report template](https://github.com/Ankitsatnami/RW_HUB_apk/issues/new?template=bug_report.yml) and include:
...
Use the [Feature Request template](https://github.com/Ankitsatnami/RW_HUB_apk/issues/new?template=feature_request.yml) and describe:
